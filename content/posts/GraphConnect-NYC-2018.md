...
> Image source: [Partial map of the Internet based on the January 15, 2005 data found on opte.org.](https://en.wikipedia.org/wiki/Complex_network#/media/File:Internet_map_1024.jpg) (node = IP address)
...
<div class="row" markdown="1">
  <div class="col-sm-7">
###### Typical questions these algorithms can help answer:  
  - Who are the key influencers in your connected data?  
  - Who has the most connections?  
  - Who is directly or indirectly connected to the largest proportion of the network?
  - Who connects distinct groups of nodes that are otherwise not connected to each other?
  - If a specific node is to be changed or removed, how important is this to the network? How many of the other nodes will be affected, and how far can these effects propagate through the graph?

  </div>
  <div class="col-sm-5" style="text-align: center;">
    <img alt="graph centrality sketch" style="width:100%;" src="/images/graph_centrality.png">
  </div>
</div>
...
<div class="row" markdown="1">
  <div class="col-sm-7">
###### Typical questions these algorithms can help answer:  
  - Are there communities in your connected data? What are they?
  - Are there hierarchical communities?
  - Are all of the nodes in the network connected?  

###### Algorithm examples:  
  - [Label propagation](https://neo4j.com/docs/graph-algorithms/current/algorithms/label-propagation/)
  - [Louvain](https://neo4j.com/docs/graph-algorithms/current/algorithms/louvain/)
  - [Triangle counting](https://neo4j.com/docs/graph-algorithms/current/algorithms/triangle-counting-clustering-coefficient/)
  - [Connected components](https://neo4j.com/docs/graph-algorithms/current/algorithms/connected-components/)

  </div>
  <div class="col-sm-5" style="text-align: center;">
    <img alt="graph communities sketch" style="width:100%;" src="/images/graph_communities.png">
  </div>
</div>
...
<div class="row" markdown="1">
  <div class="col-sm-7">
###### Typical questions these algorithms can help answer:  
  - What's the shortest path from node A to node B?
  - If we start at node A, where can we go in the graph?  
  What are the possible paths?
  - [6 degrees of separation](https://en.wikipedia.org/wiki/Six_degrees_of_separation)-based questions

###### Algorithm examples:  
  - [Shortest path](https://neo4j.com/docs/graph-algorithms/current/algorithms/shortest-path/)
  - [Minimum weight spanning tree](https://neo4j.com/docs/graph-algorithms/current/algorithms/minimum-weight-spanning-tree/)
  - [Random walk](https://neo4j.com/docs/graph-algorithms/current/algorithms/random-walk/)  

  </div>
  <div class="col-sm-5" style="text-align: center;">
    <img alt="graph path sketch" style="width:100%;" src="/images/graph_path.png">
  </div>
</div>
...
<p style="color: #818a91;
    ...
    font-size: 1.4em;
    text-align: left;
    font-weight: bold;">"Graph analysis is possibly the single most effective competitive differentiator for organizations pursuing data-driven operations and decisions."  
</p>
<p style="color: #818a91;
    font-style: italic;
    text-align:right">
...
----
The conference had some interesting book recommendations.
